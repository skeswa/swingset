...
Verified 2026-09-08 (`research/verification/2026-09-08/wsdc_*.hdr`).
...
the hash of the `extract` output (`design/parsing.md`), which includes the
...
(sometimes blank or `transparent`). `research/build_events.py` already
