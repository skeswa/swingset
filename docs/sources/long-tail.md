...
Facts from the 2026-09 research (`research/results-sources.csv`,
`research/results-sources.overrides.csv`). 15 of 177 held events in the
...
The defaults in `design/fetching.md` (5 s gap, 200 requests a day per
...
stage; see `research/scraping-techniques.md` section 10.
