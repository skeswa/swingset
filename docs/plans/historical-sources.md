...
This follows the source-specific rules: [EEPro section 10](../reference/sources/eepro.md#10-backfill)
permits origin for a missing listed file or a copy that does not parse;
[scoring.dance section 10](../reference/sources/scoring-dance.md#10-backfill) permits
missing events or incomplete round coverage; [DCN section 10](../reference/sources/danceconvention.md#10-backfill)
