...
World Dance Registry provides round and awards data. Some identities or cell meanings are incomplete; preserve the source limits described here.

[All sources](README.md) · [Shared fetching rules](../fetching.md)

## 1. Status

Verified 2026-09-08 (`journal/evidence/collection/source-survey-2026-09-08/wdr_*.hdr`).
