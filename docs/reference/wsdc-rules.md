...
Swingset uses these competition rules to interpret source results and check registry points. WSDC means World Swing Dance Council. Written rules and observed registry behavior can differ; evidence gaps are marked below.
...
From `journal/investigations/2026/prior-art-registry-analyses.md`; dates need checking
