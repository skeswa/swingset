...
This page records the project rules for public sources, personal data, and removals. Site-specific terms and review dates belong in the relevant [source guide](sources/README.md).
...
- **Terms of service.** We never accept a clickwrap. We read each site's
  posted terms if any and record the date read in `docs/reference/sources/`. If a
