...
| H14. Fair scheduling              | Allocate existing host and cycle budgets, bound backlog, and reserve repair capacity.                                                   | scheduling, fetching            | H13                                         | M    |
...
| H16. Release closure and coverage | Validate selected dependency generations and publish coverage and freshness inventories.                                                | build, publishing, data model   | H10, H15                                    | M    |
