...
[implementation plan](implementation-plan.md), whose sizes they use: S is a
...
Historical discovery extends through the separate [backfill plan](backfill.md).
...
[Scheduling](scheduling.md#event-completion) owns event selection and completion
semantics. [Local state](state.md#event-completion-persistence-h14-extension)
owns durable enumerations and turns; [operations](operations.md#event-completion-reporting-h14-extension)
owns diagnostics; [coverage](data-model.md#event-completion-coverage) owns the
