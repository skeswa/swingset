...
HELPER_MANIFEST_SHA = "f07f9c55dc7c7f7313f23b9a31edfca93a4c6e4a41fec53efda8fb0c5843d72a"
FROZEN_SOURCE = Path("/nix/store/z689qy41inndill3d92ym8im852x3649-source")
FROZEN_RECEIPT_SHA = "0c3a391aca5c32381ab10daa22adfdde44cda76ab26b68df002f9822ad4945fb"
...
def verify_database(conn,selected,gate):
    ...
    if schema!=14 or schema!=gate['schema'] or schema!=db_module.SCHEMA_VERSION:raise existing.FixtureStopped('exact runtime schema required; migration forbidden')
