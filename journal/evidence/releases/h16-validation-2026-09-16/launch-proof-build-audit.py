...
MARKER = 'f2001ab21849adfd1b3bc46b1f19d189e40b284baa438d848f64b984a4a4db5f'
REPLAY = Path('/var/tmp/swingset-h16-proof-replay')
STATE = Path('/var/tmp/swingset-h16-proof-build')
BUILD_RECEIPT = Path('/var/tmp/swingset-h16-proof-build.json')
AUDIT_RECEIPT = Path('/var/tmp/swingset-h16-proof-audit.json')
...
def main():
    ...
    held()
    mode = args.mode
    unit, monitor = f'swingset-h16-proof-{mode}.service', f'swingset-h16-proof-{mode}-monitor.service'
    resource_receipt = Path(f'/var/tmp/swingset-h16-proof-{mode}-resources.json')
