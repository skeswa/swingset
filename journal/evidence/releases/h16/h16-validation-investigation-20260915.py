...
OUTPUT = Path('/Users/skeswa/repos/skeswa/swingset/research/verification/h16-validation-investigation-20260915.json')
assert Path(closure.__file__).resolve() == SOURCE / 'src/swingset/build/closure.py'
...
report = {
    'format': 'h16-readonly-validation-investigation-v1',
