...
SUPERVISOR_SHA = "7d2746bd079a0e0fb608ae666f4cec2146ab23561c46e2d808f0f2ba2216324f"
...
def execute(args):
    ...
    try:
        ...
        driver = load_module(OPS / "initialize-002.py", DRIVER_SHA, "reviewed_initializer_verification")
        ...
        if args.mode == "verify":
            ...
            supervisor = load_module(OPS / "supervise-initialization-002.py", SUPERVISOR_SHA, "reviewed_supervisor_verification")
