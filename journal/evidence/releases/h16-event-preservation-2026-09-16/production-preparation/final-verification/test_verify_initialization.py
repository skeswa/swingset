...
spec = importlib.util.spec_from_file_location("final_init_verifier", HERE / "verify-initialization.py")
...
def supervision(inputs):
    ...
    supervisor = v.load_module(HERE.parent / "supervise-initialization.py", v.SUPERVISOR_SHA, "supervisor_guard_test")
