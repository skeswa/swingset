...
p=Path('/Users/skeswa/repos/skeswa/swingset/journal/evidence/releases/h16-event-preservation-2026-09-16/production-preparation/anchor-003-command.json')
...
out=Path('/var/tmp/h16-event-preservation-anchor-003-20260916');out.mkdir(mode=0o700)
...
if data is not None:
 with (out/'initialization-anchor-003.json').open('xb') as f:f.write(data)
