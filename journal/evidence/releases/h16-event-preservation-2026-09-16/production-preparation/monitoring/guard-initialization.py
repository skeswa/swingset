...
SUPERVISOR_SHA256 = '9d48562395750244fb64c8420390c3402c8af2aea2019e46bb66577c1b3c4312'
ANON_LIMIT = 6 * 1024**3
INTERVAL = 5.0
START_SECONDS = 30.0
...
def no_other_workers():
    ...
    if result.stdout.strip():
        raise ValueError('another H16 unit is active; heavy work must remain serial')
    ...
    class GuardedBackend(supervisor.Backend):
        ...
        def sample(self, *, process_finished=False):
            ...
            try:
                ...
                if fields.get('LoadState') == 'not-found' and sample['elapsed_seconds'] > START_SECONDS and not process_finished:
