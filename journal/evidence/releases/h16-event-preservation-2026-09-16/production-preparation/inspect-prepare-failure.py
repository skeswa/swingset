"""Bounded metadata-only equality check after prepare failed before any write opener."""
import fcntl
import hashlib
import json
import os
...
OUT = Path('/var/tmp/h16-event-preservation-initialization-prepare-20260916/failure-preservation.json')
