...
OBSERVATION_SCRIPT = EVIDENCE / "actual-review-002/migration-observation.py"
...
result = {
    ...
    "independent_observation": {
        ...
        "vm_observation": {
            "path": "../actual-review-002/migration-observation.json",
            "sha256": sha(OBSERVATION_PATH),
            "script_path": "../actual-review-002/migration-observation.py",
            "script_sha256": sha(OBSERVATION_SCRIPT),
        },
