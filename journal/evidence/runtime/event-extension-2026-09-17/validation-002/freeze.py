...
out=Path('/tmp/swingset-extension-freeze-20260917-002')
...
receipt={'format':'event-extension-source-v1','created_at':datetime.now(UTC).isoformat(),'parent':subprocess.check_output(['jj','log','-r','@-','--no-graph','-T','commit_id']).decode(),'schema':28,'files':actual,'deployed':False,'published':False}
