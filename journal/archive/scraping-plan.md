...
Written 2026-09-08 from the research in `journal/investigations/2026/scraping-techniques.md`
and the playbooks in `docs/reference/sources/`. This is the order of work for the
fetch and parse side of the pipeline. It refines [milestones](../../docs/plans/milestones.md);
...
| Change                                                                                                                                                                                                                                      | Where                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| Each page kind has one pure `extract(body) -> Extract`; its canonical hash is the fingerprint and its content is the input to record construction, so nothing is parsed twice. Unchanged fingerprint: body discarded, `checked_at` recorded | [fetching](../../docs/reference/fetching.md#change-detection), [parsing](../../docs/reference/parsing.md#contract)                |
| `Accept-Encoding: gzip` only, never brotli, so Apache's `-gzip` ETag suffix is stable and every client we run decodes it                                                                                                                    | [fetching](../../docs/reference/fetching.md#politeness-rules)                                                                     |
| Per-host byte budget in addition to the request budget; defaults in fetching.md, overrides only in playbooks                                                                                                                                | [fetching](../../docs/reference/fetching.md#politeness-rules)                                                                     |
| The Wayback Machine is a host in `hosts.toml` and a transport in the fetch layer; backfill watches carry an archive URL                                                                                                                     | [fetching](../../docs/reference/fetching.md#archive), [scheduling](../../docs/reference/scheduling.md#watch-states-and-intervals) |
| Watch kind `autoindex` (EEPro) and `json` (WDR)                                                                                                                                                                                             | [scheduling](../../docs/reference/scheduling.md#watches)                                                                          |
| World Dance Registry is a source with its own discovery (link scan plus overrides)                                                                                                                                                          | [sources](../investigations/undated/initial-source-survey.md#world-dance-registry-pro-score-scoresworlddanceregistrycom)          |
| `overrides/source_urls.csv` feeds long-tail and WDR watches                                                                                                                                                                                 | [repository layout](../../docs/how-it-works/code-map.md)                                                                          |
| Robots: a `User-agent: swingset` group is honored above the wildcard; 4xx including 403 means unrestricted                                                                                                                                  | [fetching](../../docs/reference/fetching.md#politeness-rules)                                                                     |
...
- Discovery: `overrides/source_urls.csv` seeded from
  `journal/evidence/collection/source-survey-2026-09-04/results-sources.csv`; the daily event-site link scan that
...
Owned by [backfill](../../docs/reference/backfill.md), work packages WP11 to WP16.
...
Not repeated here. Defaults are in [fetching](../../docs/reference/fetching.md#politeness-rules);
