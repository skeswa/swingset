...
[v2 progress](v2-implementation-evidence.md). Stage V1 of the v2 plan is complete at public
...
[the implementation plan](v1-implementation-plan.md); it does not
...
scheduled jobs and final activation passed; issue #9 is closed. See the [runbook](../../docs/guides/operation.md) for the active handoff and restore
evidence.
...
[the 2026-09-10 data-quality repair report](../investigations/2026/data-quality-repair-2026-09-10.md).
