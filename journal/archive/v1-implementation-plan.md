...
See [implementation status](v1-implementation-evidence.md) for implemented
...
refines [milestones](../../docs/plans/milestones.md) and [scraping plan](scraping-plan.md).
Work after v1 is ordered by [implementation plan v2](../../docs/plans/history-and-recovery.md).
...
Per [technology](../../docs/reference/technology.md): nix owns Python 3.12, `uv`, and
...
| Contract                                                   | Owner                                                    |
| ---------------------------------------------------------- | -------------------------------------------------------- |
| Observation ownership, matching map, projection, findings  | [Architecture](../../docs/reference/architecture.md)     |
| SQLite schema, invalidation, durable work, state directory | [Local state](../../docs/reference/state.md)             |
| Extract, parse, source interfaces, fixtures                | [Parsing](../../docs/reference/parsing.md)               |
| Response classification and host gate                      | [Fetching](../../docs/reference/fetching.md)             |
| Watch policy and discovery                                 | [Scheduling](../../docs/reference/scheduling.md)         |
| Build inputs, review queue, immutable output               | [Build](../../docs/reference/build.md)                   |
| Candidate identity, recovery, baseline promotion           | [Publishing](../../docs/reference/publishing.md)         |
| Cycle, locks, pause, backup and restore                    | [Operations](../../docs/reference/operations.md)         |
| Modules and files                                          | [Repository layout](../../docs/how-it-works/code-map.md) |
...
defaults from [fetching](../../docs/reference/fetching.md#politeness-rules); `clock.py`;
...
[local state](../../docs/reference/state.md#sqlite-schema); `model/ids.py` implementing every id in
[data model](../../docs/reference/data-model.md#identifiers) with tests for slugging,
`-2` suffixes, and the name-form entry id; `model/enums.py` as
`StrEnum`s, and `docs/reference/enums.md` generated from them by
...
and [fetching](../../docs/reference/fetching.md): one in flight per host, `next_allowed_at`,
`Crawl-delay`, `Retry-After` (seconds and date), request and byte
budgets per day, `fetch/classify.py` following
[response classification](../../docs/reference/fetching.md#response-classification), with the
...
Change detection in the order [fetching](../../docs/reference/fetching.md#change-detection)
...
implementing the state table in [scheduling](../../docs/reference/scheduling.md#watch-states-and-intervals)
...
priority order in [scheduling](../../docs/reference/scheduling.md#work-order);
`schedule/cycle.py` implementing [cycle order](../../docs/reference/operations.md#cycle),
wall-clock budgets, [interruption recovery](../../docs/reference/operations.md#interruption-and-recovery),
...
[operator command semantics](../../docs/reference/operations.md#locks-and-operator-commands).
...
[scheduling](../../docs/reference/scheduling.md#discovery) (calendar, matching, event
...
also carries [publication reconciliation](../../docs/reference/publishing.md#candidate-and-baseline)
...
from `journal/tools/collection/build_events.py`, `change_mode = "extract"` with the
...
[interruption recovery](../../docs/reference/operations.md#interruption-and-recovery) passes for fetch, parse, and project at every
...
retry policy in [operations](../../docs/reference/operations.md#locks-and-operator-commands);
...
the graceful stop of [interruption recovery](../../docs/reference/operations.md#interruption-and-recovery).
`nix/hosts/orb.nix` and `nixosConfigurations.orb` in the flake.
`docs/guides/operation.md` sections: create the machine, rebuild, read logs,
...
table; `build/` implementing [build inputs and immutable contents](../../docs/reference/build.md),
invariants, suppression, review, changelog, and manifest; `publish/`
implementing [candidate and baseline](../../docs/reference/publishing.md#candidate-and-baseline),
Hub commits, and the dataset card; `backup/` implementing the complete
checkpoint and activation protocol in
[backup and restore](../../docs/reference/operations.md#backup-and-restore). Runtime bootstrap
...
[build acceptance cases](../../docs/reference/build.md#acceptance-cases),
[publication recovery cases](../../docs/reference/publishing.md#publication-acceptance-cases),
...
[registry playbook](../../docs/reference/sources/wsdc-registry.md#9-quirks)
...
[sources](../investigations/undated/initial-source-survey.md#registry-json-shape-lookup2020find-trimmed); an
...
[identity linking](../../docs/reference/identity-linking.md#name-normalization) and
...
the [event projection](../../docs/reference/architecture.md#observations-and-projections)
...
signals in [identity linking](../../docs/reference/identity-linking.md#scoring-and-methods)
...
unmatched entries. These complete the [invalidation cases](../../docs/reference/state.md#acceptance-cases).
...
discovery step 2 of [scheduling](../../docs/reference/scheduling.md#discovery) for this
...
`points_matches_expected` from [WSDC rules](../../docs/reference/wsdc-rules.md) using the
...
`gone`) instead of pausing the host ([response classification](../../docs/reference/fetching.md#response-classification)). Discovery from
`overrides/source_urls.csv` (`event_id, source, kind, url, parser,
notes`), seeded by a one-off script from `journal/evidence/collection/source-survey-2026-09-04/results-sources.csv`
...
- `docs/guides/operation.md` complete; `README.md` rewritten as the page the
