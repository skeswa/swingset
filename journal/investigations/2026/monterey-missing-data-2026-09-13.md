...
2. **Acquisition backlog.** There are 3,757 scoring.dance round watches that
   ...
   by the operator marker described in `journal/investigations/2026/2026-09-15-release-handoff.md`. These facts
...
- [Production state query](../../evidence/quality/monterey-2026-09-13/production-evidence.json)
- [Monterey watch inventory](../../evidence/quality/monterey-2026-09-13/watches.json)
- [Offline replay results and personal source rows](../../evidence/quality/monterey-2026-09-13/replay-report.json)
