# Checking the first identity correction release (V1)
...
The offline audit is implemented in `journal/tools/releases/v1_correction_acceptance.py`.
...
```sh
python -m journal.tools.releases.v1_correction_acceptance \
...
[`verification/v1-correction-20260913.json`](../../evidence/releases/v1/v1-correction-20260913.json).
