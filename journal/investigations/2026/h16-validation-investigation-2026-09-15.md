# Why full-build validation exceeded its deadline (H16)
...
- [Fresh read-only measurements and profile](../../evidence/releases/h16/h16-validation-investigation-20260915.json), SHA-256 `b8fe7151df1509366e45a803dee9aa05bddd7aaaa1a5ce3278e8efe2bcb388e1`.
- [Exact diagnostic script](../../evidence/releases/h16/h16-validation-investigation-20260915.py). It takes the existing scratch writer lock, requires an empty WAL, opens SQLite read-only with immutable mode, checks source and candidate hashes, and bounds the diagnostic at 180 seconds. It refuses to overwrite its report.
- [Original failed-build journal](../../evidence/releases/h16/h16-closure-build-journal-20260915.log).
- [Original build receipt](../../evidence/releases/h16/h16-closure-build-20260915.json).
