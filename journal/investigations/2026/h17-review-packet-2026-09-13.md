# Preparing a representative identity review (H17)
...
Identity evaluation needs a representative sample and independent human review. This record describes the prepared review material. The original work ID is H17.
...
[h17-review-packet-20260913.json](../../evidence/identity/h17/h17-review-packet-20260913.json).
Reproduce with [prepare_identity_review.py](../../tools/identity/prepare_identity_review.py), the
