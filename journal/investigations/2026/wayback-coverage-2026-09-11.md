...
`docs/reference/backfill.md`. It is a snapshot; it is not kept up to date.
...
(`journal/investigations/undated/initial-source-survey.md`), so the archive is the only copy.
