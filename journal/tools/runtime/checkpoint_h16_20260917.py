...
def main() -> None:
    ...
    if args.checkpoint:
        require(
            args.checkpoint.exists() == args.resume_checkpoint,
            "checkpoint existence differs from requested mode",
        )
            ...
            if args.checkpoint:
                if args.resume_checkpoint:
                    ...
                    checkpoint = Checkpoint(
                        args.checkpoint, sha(args.checkpoint / "checkpoint.json"), manifest["files"]
                    )
                else:
