...
Usage:
    .venv/bin/python journal/tools/quality/missing_data_events.py CAPTURE_DIR OUTPUT_DIR
...
def main() -> None:
    ...
    event_leads = read_leads(
        repo / "journal/evidence/collection/source-survey-2026-09-04/events.csv"
    )
    result_leads = read_leads(
        repo / "journal/evidence/collection/source-survey-2026-09-04/results-sources.csv"
    )
