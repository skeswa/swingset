"""Turn the wcs-results-sources workflow output into journal/evidence/collection/source-survey-2026-09-04/results-sources.csv.
...
HERE = pathlib.Path(__file__).resolve().parents[2] / "evidence/collection/source-survey-2026-09-04"
