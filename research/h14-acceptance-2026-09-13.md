...
[Gate](verification/h14-production-gate.json),
[preflight](verification/h14-production-preflight.json), and
[execution](verification/h14-production-execution.json) retain the comparisons.
