...
The [replay receipt](verification/h7-contract4-replay-20260913.json) records
...
The [read-only projected impact audit](verification/h7-unsupported-scoring-impact-20260913.json)
...
Reproduce with `research/rehearse_source_admission.py`, supplying a new
...
`research/compare_admission_replay.py` and
`research/assess_unsupported_scoring.py` against the completed clone. Both
