...
Rebuild with [h14_shadow_load.py](h14_shadow_load.py), using the service Python:

```sh
python research/h14_shadow_load.py --state /var/lib/swingset > /tmp/h14-load.json
```
...
[Machine receipt](verification/h14-shadow-load-2026-09-13.json), SHA-256
...
[`verification/h14-picker-cost-2026-09-13.json`](verification/h14-picker-cost-2026-09-13.json)
