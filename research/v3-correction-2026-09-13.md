...
Receipts: [build](verification/v3-rehearsal-20260913.json),
[acceptance](verification/v3-acceptance-20260913.json),
[integrity](verification/v3-integrity-20260913.json),
[production build](verification/v3-production-build-20260913.json),
[production acceptance](verification/v3-production-acceptance-20260913.json),
[production integrity](verification/v3-production-integrity-20260913.json),
[verified publication](verification/v3-production-publication-20260913.json).
