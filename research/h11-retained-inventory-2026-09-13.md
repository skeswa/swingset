# Retained requirement inventory timing, 2026-09-13
...
Machine receipt: [h11-retained-inventory-20260913.json](verification/h11-retained-inventory-20260913.json).
Reproduce with [benchmark_requirements.py](benchmark_requirements.py), on a
...
```sh
PYTHONPATH=src python research/benchmark_requirements.py \
...
Receipt: [h11-retained-fk-indexes-20260913.json](verification/h11-retained-fk-indexes-20260913.json).
Reproduce on the disposable copy with
[benchmark_fk_indexes.py](benchmark_fk_indexes.py):

```sh
PYTHONPATH=src python research/benchmark_fk_indexes.py \
  --state /var/tmp/swingset-h11-review \
...
Receipt: [h11-schema10-cohort-benchmark-20260913.json](verification/h11-schema10-cohort-benchmark-20260913.json).
