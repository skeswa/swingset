# V3 retained identity withdrawals
...
The exact candidate manifest SHA-256 is `b5cf073615019ce3f5e64f1405071551d6c2c3e799fb6f17517dbdfd64bc15e4`. The [receipt](verification/v3-identity-classification-20260913.json) pins the policy token, artifact hashes, counts, and inspection limits. No network requests, state changes, builds, or publication were performed for this audit.
...
Sixteen representative scoring.dance bodies and five registry profile bodies were read from the retained archive and verified against their SHA-256 digests. The [source proof](verification/v3-identity-source-proof-20260913.json) preserves exact cell attributes, source URLs, raw row text, registry identity fields, and registry competition records.
