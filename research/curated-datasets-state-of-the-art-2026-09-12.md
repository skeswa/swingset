...
The following requirements extend the [self-healing proposal](../design/self-healing.md).
...
source notes; the [source inventory](verification/2026-09-12/curated-datasets/sources.json)
