...
The latest [resume handoff](../docs/v2-resume.md) records production on schema
...
5. **Capacity needs measurement.** A retained H16 preflight reports a
   ...
   [Preflight](verification/h16-changelog-production-preflight.json),
   [resume notes](../docs/v2-resume.md).
