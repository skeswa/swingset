...
from bootstrap_parse import BootstrapParser
        ...
        for kind in (*KINDS4, "eepro.autoindex"):
            ...
            with database.transaction():
                reviewed = record_corpus_review(
                    ...
                    evidence="Reviewed retained corpus and isolated replay; research/h6-contract4-review-2026-09-13.md and research/h6-autoindex-contract5-review-2026-09-13.md",
                )
