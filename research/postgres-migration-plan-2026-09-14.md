...
For implementation, follow the [migration execution plan](../design/dokploy-migration-plan.md).
...
The [latest operating handoff](../docs/v2-resume.md) records a held schema-14
