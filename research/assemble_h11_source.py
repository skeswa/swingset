...
OVERLAYS = (
    ...
    "research/benchmark_requirements.py",
    "research/benchmark_identity_references.py",
    "research/h11-acceptance-2026-09-13.md",
    "research/h11-retained-inventory-2026-09-13.md",
    "research/h11-deployment-preparation.md",
    "research/verification/h11-schema10-cohort-benchmark-20260913.json",
    "research/verification/h11-final-lag-report-20260913.json",
    "research/assemble_h11_source.py",
    "research/accept_h11.py",
)
...
def main() -> None:
    ...
    parser.add_argument("--reviewed", type=Path, default=Path(__file__).resolve().parents[1])
