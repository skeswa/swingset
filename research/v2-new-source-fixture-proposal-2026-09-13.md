# Proposed new-source fixture exception
...
The [machine manifest](v2-new-source-fixture-targets-2026-09-13.json) is the
...
first fetch ([implementation plan, lines 41–47](../design/implementation-plan-v2.md#2-the-ordering-rule))
...
headers alone do not qualify ([parsing, lines 154–165](../design/parsing.md#fixtures-and-tests)).
Each new source kind also needs its own contract and fixtures
([rollout, lines 57–60](../design/self-healing-rollout.md#second-tranche-continuous-repair-and-measured-accuracy)).
...
[capture inventory](verification/2026-09-11/README.md) describe preliminary
...
required by [parsing](../design/parsing.md#parsing-rules), remain a
...
2009–2016 events ([backfill, lines 7 and 371](../design/backfill.md)). Keep the
