# H13 pause and status acceptance
...
[Measured test receipt](verification/h13-control-scenarios-20260913.xml).
...
Receipts: [execution](verification/h13-production-execution.json),
[preflight](verification/h13-production-preflight.json),
[gate](verification/h13-production-gate.json),
[backup](verification/h13-production-backup.json), and
[remote verification](verification/h13-production-private-verification.json).
